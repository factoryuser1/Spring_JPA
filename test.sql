...
insert into lessons (title, delivered_on) values ('Spring 5', '2018-02-05');
insert into lessons (title, delivered_on) values ('Spring Boot', '2017-04-06');
insert into lessons (title, delivered_on) values ('Ammar', '2020-05-02');